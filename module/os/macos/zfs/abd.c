 ...
 * Copyright (c) 2017 by Jorgen Lundman. All rights reserved.
 */
...
/*
 * macOS implementational differences include the abd_move support, which
 * has shown to improve fragmentation in the XNU kernel.
 */
 ...
 */
int
abd_cmp_size(abd_t *dabd, abd_t *sabd, size_t size)
{
	VERIFY_ABD_MAGIC(dabd);
	VERIFY_ABD_MAGIC(sabd);
